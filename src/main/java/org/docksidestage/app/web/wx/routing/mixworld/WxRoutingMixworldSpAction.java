 ...
 */
@AllowAnyoneAccess
public class WxRoutingMixworldSpAction extends FortressBaseAction {

    // ===================================================================================
    //                                                                             Execute
    //                                                                             =======
    // http://localhost:8151/fortress/sp/wx/routing/mixworld/sea
    //   => originally: http://localhost:8151/fortress/wx/routing/mixworld/sp/sea
    // http://localhost:8151/fortress/sp/wx/routing/mixworld/sea/land
    //   => originally: http://localhost:8151/fortress/wx/routing/mixworld/sp/sea/land
    @Execute
    ...
    // http://localhost:8151/fortress/sp/wx/routing/mixworld/maihama/sea/land
    //   => originally: http://localhost:8151/fortress/wx/routing/mixworld/sp/maihama/sea/land
    @Execute
