...
public interface HarborCDef extends Classification {
    ...
    public enum DefMeta implements ClassificationMeta {
        /** Harbor's Member Status */
        MemberStatus(cd -> HarborCDef.MemberStatus.of(cd), nm -> HarborCDef.MemberStatus.byName(nm)
        , () -> HarborCDef.MemberStatus.listAll(), gp -> HarborCDef.MemberStatus.listByGroup(gp)
    ...
    public static class ZzzoneSlimmer<CLS extends HarborCDef> {
