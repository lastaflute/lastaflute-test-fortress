 ...
 * @author FreeGen
 */
public class UsingEntityVariablePostcard extends LaTypicalPostcard implements org.docksidestage.mylasta.mail.PluggedinFortressPostcard {

    // ===================================================================================
    //                                                                          Definition
    //                                                                          ==========
    public static final String PATH = "whitebox/using_entity_variable.dfmail";

    // ===================================================================================
    //                                                                         Entry Point
    //                                                                         ===========
    public static UsingEntityVariablePostcard droppedInto(Postbox postbox, MPCall<UsingEntityVariablePostcard> postcardLambda) {
        UsingEntityVariablePostcard postcard = new UsingEntityVariablePostcard();
