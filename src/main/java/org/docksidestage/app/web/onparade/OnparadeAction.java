...
import org.docksidestage.mylasta.template.Rootest;
import org.docksidestage.mylasta.template.bean.NestedBean;
...
public class OnparadeAction extends FortressBaseAction {
    ...
    public HtmlResponse index(OptionalThing<Integer> pageNumber, OnparadeSearchForm form) {
        ...
        String text = Rootest.parsedBy(templateManager, bean -> {
            bean.setSea("aa");
            bean.setLand("");
        });
        ...
        String nested = NestedBean.parsedBy(templateManager, bean -> {
            bean.setSea("aa");
            bean.setLand("");
        });
