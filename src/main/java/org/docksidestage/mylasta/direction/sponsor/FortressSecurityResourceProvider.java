 ...
 * @author jflute
 */
public class FortressSecurityResourceProvider implements SecurityResourceProvider {
    ...
    public FortressSecurityResourceProvider(InvertibleCryptographer primaryInvertibleCryptographer,
