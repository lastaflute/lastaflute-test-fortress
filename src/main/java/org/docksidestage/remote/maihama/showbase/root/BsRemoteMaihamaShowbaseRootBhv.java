...
/**
 * The base class as generation gap for remote API of root.
 * @author FreeGen
 */
public abstract class BsRemoteMaihamaShowbaseRootBhv extends AbstractRemoteMaihamaShowbaseBhv {
     ...
     */
    public BsRemoteMaihamaShowbaseRootBhv(RequestManager requestManager) {
