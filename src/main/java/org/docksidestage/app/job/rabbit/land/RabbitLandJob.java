 ...
 * @author jflute
 */
public class RabbitLandJob extends RabbitJobBase<RabbitLandMessageBody> {

    private static final Logger logger = LoggerFactory.getLogger(RabbitLandJob.class);
    ...
    @Override
    protected Class<RabbitLandMessageBody> getMessageJsonType() {
        // #rabbit jflute メッセージ文字列をJSONとして受け取るためのクラスの型を指定する (2025/01/17)
        return RabbitLandMessageBody.class;
    }
}
