 ...
 * @author jflute
 */
public class LandMQAgent extends MQBaseAgent { // #rabbit

    // ===================================================================================
    //                                                                          Definition
    //                                                                          ==========
    // #genba_fitting ずばりキューの名前
    private static final String QUEUE_NAME = "landQueue";
    ...
    public static final String JOB_UNIQUE_CODE = "onemanJob";

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public LandMQAgent(FortressConfig config, RabbitMQConsumerManager consumerManager) {
