 ...
 */
package org.docksidestage.remote.fortressman.base;
 ...
 * @author jflute
 */
public class RemoteFrUnifiedFailureResult {
    ...
    public RemoteFrUnifiedFailureResult(RemoteUnifiedFailureType cause, List<RemoteFailureErrorPart> errors) {
        this.cause = cause;
        this.errors = errors;
    }
