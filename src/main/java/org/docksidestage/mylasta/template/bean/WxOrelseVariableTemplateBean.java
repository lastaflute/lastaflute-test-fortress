 ...
 * @author FreeGen
 */
public class WxOrelseVariableTemplateBean implements TemplatePmb {

    public static final String PATH = "bean/wx_orelse_variable_template.dfpm";

    public static String parsedBy(TemplateManager templateManager, TPCall<WxOrelseVariableTemplateBean> oneArgLambda) {
        WxOrelseVariableTemplateBean pmb = new WxOrelseVariableTemplateBean();
    ...
    public String toString() {
        ...
        sb.append("WxOrelseVariableTemplateBean:{");
        sb.append(sea);
