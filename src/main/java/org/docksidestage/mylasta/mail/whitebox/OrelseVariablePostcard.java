 ...
 * @author FreeGen
 */
public class OrelseVariablePostcard extends LaTypicalPostcard implements org.docksidestage.mylasta.mail.PluggedinFortressPostcard {

    // ===================================================================================
    //                                                                          Definition
    //                                                                          ==========
    public static final String PATH = "whitebox/orelse_variable.dfmail";

    // ===================================================================================
    //                                                                         Entry Point
    //                                                                         ===========
    public static OrelseVariablePostcard droppedInto(Postbox postbox, MPCall<OrelseVariablePostcard> postcardLambda) {
        OrelseVariablePostcard postcard = new OrelseVariablePostcard();
    ...
    protected String[] getPropertyNames() {
        return new String[] {"memberName", "description"};
    }
    ...
    /**
     * Set the value of description, used in parameter comment. <br>
     * Even if empty string, treated as empty plainly. So "IF pmb != null" is false if empty.
     * @param description The parameter value of description. (NotNull)
     */
    public void setDescription(String description) {
        registerVariable("description", description);
    }
}
