 ...
 * @author FreeGen
 */
public class LoopBeansPostcard extends LaTypicalPostcard implements org.docksidestage.mylasta.mail.PluggedinFortressPostcard {

    // ===================================================================================
    //                                                                          Definition
    //                                                                          ==========
    public static final String PATH = "whitebox/loop_beans.dfmail";

    // ===================================================================================
    //                                                                         Entry Point
    //                                                                         ===========
    public static LoopBeansPostcard droppedInto(Postbox postbox, MPCall<LoopBeansPostcard> postcardLambda) {
        LoopBeansPostcard postcard = new LoopBeansPostcard();
