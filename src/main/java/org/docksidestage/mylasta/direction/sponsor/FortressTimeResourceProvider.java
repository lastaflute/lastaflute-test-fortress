 ...
 * @author jflute
 */
public class FortressTimeResourceProvider extends TypicalTimeResourceProvider {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected final FortressConfig maihamaConfig;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public FortressTimeResourceProvider(FortressConfig maihamaConfig) {
    ...
    protected TimeZone getCentralTimeZone() {
        return FortressUserTimeZoneProcessProvider.centralTimeZone;
    }
