...
public class WxJsonManagerTest extends UnitFortressBasicTestCase {
    ...
    public void test_fromJson_hierarchical() { // #hope jflute more test, Json hierarchical (2022/04/18)
        ...
        result.objectGenericInnerPartRowList =
                new ArrayList<WxResponseJsonSwaggerResult.WxResponseJsonObjectGenericPart<WxResponseJsonRowInnerPart>>();
    ...
    private WxResponseJsonObjectGenericPart<WxResponseJsonRowInnerPart> createGeneritPart() {
        ...
        WxResponseJsonRowInnerPart innerPart = createInnerPart();
        genericPart.landList = Lists.immutable.of(innerPart);
        return genericPart;
    }
