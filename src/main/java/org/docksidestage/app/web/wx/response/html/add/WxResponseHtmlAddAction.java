 ...
 * @author jflute
 */
public class WxResponseHtmlAddAction extends FortressBaseAction {
    ...
    @Execute
    public HtmlResponse register(WxResponseHtmlAddForm form) {
    ...
    //                                                                              Update
    //                                                                              ======
    private void insertMember(WxResponseHtmlAddForm form) {
