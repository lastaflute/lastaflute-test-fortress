...
import org.docksidestage.mylasta.direction.sponsor.FortressApiFailureHook.UnifiedFailureResult.FailureErrorPart;
 ...
 * @author jflute
 */
public class FortressApiFailureHook implements ApiFailureHook { // #change_it for handling API failure
