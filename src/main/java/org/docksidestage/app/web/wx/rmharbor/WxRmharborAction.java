...
public class WxRmharborAction extends FortressBaseAction {
    ...
    public HtmlResponse translate(WxRmharborProductSearchForm form) { // can translate validation error automatically
        ...
        RemotePagingReturn<RemoteProductRowReturn> ret = requestProductList(form);
    ...
    private RemotePagingReturn<RemoteProductRowReturn> requestProductList(WxRmharborProductSearchForm form) {
    ...
    private WxRmharborProductSearchRowBean mappingToRowBean(RemoteProductRowReturn row) {
    ...
    private PagingResultBean<Product> mappingToPage(RemotePagingReturn<RemoteProductRowReturn> ret) {
