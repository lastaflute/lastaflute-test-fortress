...
/**
 * The bean class as return for remote API of POST /products/.
 * @author FreeGen
 */
public class RemoteProductsReturn {
    ...
    public org.eclipse.collections.api.list.ImmutableList<ProductsRowPart> rows;

    /**
     * The part class of ProductsRowPart.
     * @author FreeGen
     */
