 ...
 */
public class ChouMiniClusterConfiguration {
    ...
    private final ChouMiniCluster.HaServices haServices;
    ...
    public ChouMiniClusterConfiguration(Configuration configuration, int numTaskManagers, RpcServiceSharing rpcServiceSharing,
            @Nullable String commonBindAddress, ChouMiniCluster.HaServices haServices, @Nullable PluginManager pluginManager) {
    ...
    public String getJobManagerExternalAddress() {
        return commonBindAddress != null ? commonBindAddress : configuration.get(JobManagerOptions.ADDRESS, "localhost");
    }

    public String getTaskManagerExternalAddress() {
        return commonBindAddress != null ? commonBindAddress : configuration.get(TaskManagerOptions.HOST, "localhost");
    }
    ...
    public String getJobManagerBindAddress() {
        return commonBindAddress != null ? commonBindAddress : configuration.get(JobManagerOptions.BIND_HOST, "localhost");
    }

    public String getTaskManagerBindAddress() {
        return commonBindAddress != null ? commonBindAddress : configuration.get(TaskManagerOptions.BIND_HOST, "localhost");
    }
    ...
    public ChouMiniCluster.HaServices getHaServices() {
        return haServices;
    }

    @Override
    public String toString() {
        return "MiniClusterConfiguration {" + "singleRpcService=" + rpcServiceSharing + ", numTaskManagers=" + numTaskManagers
                + ", commonBindAddress='" + commonBindAddress + '\'' + ", config=" + configuration + '}';
    }
    ...
    public static class Builder {
        ...
        private ChouMiniCluster.HaServices haServices = ChouMiniCluster.HaServices.CONFIGURED;
        ...
        public Builder setHaServices(ChouMiniCluster.HaServices haServices) {
            this.haServices = haServices;
            return this;
        }
        ...
        public ChouMiniClusterConfiguration build() {
            ...
            modifiedConfiguration.set(RestOptions.ADDRESS, modifiedConfiguration.get(RestOptions.ADDRESS, "localhost"));
            ...
            return new ChouMiniClusterConfiguration(modifiedConfiguration, numTaskManagers, rpcServiceSharing, commonBindAddress,
                    haServices, pluginManager);
        }
    }
}
